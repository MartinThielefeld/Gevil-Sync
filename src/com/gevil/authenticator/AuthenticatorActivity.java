...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    public void handleLogin(View view) {
        ...
        if (TextUtils.isEmpty(mUsername) || TextUtils.isEmpty(mPassword)) {
            ...
            mAuthThread =
                SyncAdapterNetworkUtilities.attemptAuth(mUsername, mPassword, mHandler,
    ...
    protected void finishLogin() {
       //System.out.println("+ finishLogin 1");
    	Log.i(TAG, "finishLogin()");
         Account account = new Account(mUsername, Constants.ACCOUNT_TYPE);

        //System.out.println("+ finishLogin 2");
        if (mRequestNewAccount) {
        	//System.out.println("+ finishLogin 2a");
        	...
        	//System.out.println("+ finishLogin 2b");
        	mAccountManager.setPassword(account, mPassword);
        }
        
        //System.out.println("+ finishLogin 3");
       ...
       // System.out.println("+ finishLogin 4");
    ...
    private CharSequence getMessage() {
        getString(R.string.syncAdapterLabel);
